export namespace DefaultTheme {
  export interface Config {
    ...
    /**
     * If your site are in a different repository from your main project.
     *
     * @example `"vuejs/site-next"`
     */
    docsRepo?: string

    /**
     * If your site are not at the root of the repo.
     *
     * @example `"site"`
     */
    docsDir?: string
    ...
    /**
     * If your site are in a different branch. Defaults to `master`.
     *
     * @example `"next"`
     */
    docsBranch?: string
